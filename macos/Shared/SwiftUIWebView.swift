...
extension WebViewCoordinator: WKNavigationDelegate {
    ...
    public func webView(_ webView: WKWebView,
        ...
        // handle <a target="__blank" />, thanks: https://stackoverflow.com/a/27391215
...
// Thanks: WKWebView Javascript Alerts on iOS and macOS in Swift - https://www.advancedswift.com/wkwebview-javascript-alerts-in-swift/
extension WebViewCoordinator: WKUIDelegate {
    public func webView(_ webView: WKWebView,
        ...
        // Take host as title
        if let title = frame.webView?.url?.host {
